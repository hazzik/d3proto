...
namespace bnet.protocol.server_pool {
  ...
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial interface IServerPoolService {
    global::bnet.protocol.server_pool.PoolStateResponse GetPoolState(global::bnet.protocol.server_pool.PoolStateRequest poolStateRequest);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class ServerPoolService : IServerPoolService, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public ServerPoolService(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public ServerPoolService(pb::IRpcDispatch dispatch, bool dispose) {
    ...
    public global::bnet.protocol.server_pool.PoolStateResponse GetPoolState(global::bnet.protocol.server_pool.PoolStateRequest poolStateRequest) {
       return dispatch.CallMethod("GetPoolState", poolStateRequest, global::bnet.protocol.server_pool.PoolStateResponse.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly IServerPoolService implementation;
      public Dispatch(IServerPoolService implementation) : this(implementation, true) {
      }
      public Dispatch(IServerPoolService implementation, bool dispose) {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "GetPoolState": return response.MergeFrom(implementation.GetPoolState((global::bnet.protocol.server_pool.PoolStateRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(IServerPoolService).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public ServerStub(IServerPoolService implementation) : this(implementation, true) {
      }
      public ServerStub(IServerPoolService implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "GetPoolState": return implementation.CallMethod(methodName, global::bnet.protocol.server_pool.PoolStateRequest.ParseFrom(input, registry), global::bnet.protocol.server_pool.PoolStateResponse.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(IServerPoolService).FullName, methodName);
        }
      }
    }
