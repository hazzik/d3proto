...
namespace bnet.protocol.toon.external {
  ...
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial interface IToonServiceExternal {
    global::bnet.protocol.toon.external.ToonListResponse ToonList(global::bnet.protocol.toon.external.ToonListRequest toonListRequest);
    global::bnet.protocol.toon.external.SelectToonResponse SelectToon(global::bnet.protocol.toon.external.SelectToonRequest selectToonRequest);
    global::bnet.protocol.toon.external.CreateToonResponse CreateToon(global::bnet.protocol.toon.external.CreateToonRequest createToonRequest);
    global::bnet.protocol.toon.external.DeleteToonResponse DeleteToon(global::bnet.protocol.toon.external.DeleteToonRequest deleteToonRequest);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class ToonServiceExternal : IToonServiceExternal, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public ToonServiceExternal(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public ToonServiceExternal(pb::IRpcDispatch dispatch, bool dispose) {
    ...
    public global::bnet.protocol.toon.external.ToonListResponse ToonList(global::bnet.protocol.toon.external.ToonListRequest toonListRequest) {
       return dispatch.CallMethod("ToonList", toonListRequest, global::bnet.protocol.toon.external.ToonListResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.toon.external.SelectToonResponse SelectToon(global::bnet.protocol.toon.external.SelectToonRequest selectToonRequest) {
       return dispatch.CallMethod("SelectToon", selectToonRequest, global::bnet.protocol.toon.external.SelectToonResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.toon.external.CreateToonResponse CreateToon(global::bnet.protocol.toon.external.CreateToonRequest createToonRequest) {
       return dispatch.CallMethod("CreateToon", createToonRequest, global::bnet.protocol.toon.external.CreateToonResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.toon.external.DeleteToonResponse DeleteToon(global::bnet.protocol.toon.external.DeleteToonRequest deleteToonRequest) {
       return dispatch.CallMethod("DeleteToon", deleteToonRequest, global::bnet.protocol.toon.external.DeleteToonResponse.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly IToonServiceExternal implementation;
      public Dispatch(IToonServiceExternal implementation) : this(implementation, true) {
      }
      public Dispatch(IToonServiceExternal implementation, bool dispose) {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "ToonList": return response.MergeFrom(implementation.ToonList((global::bnet.protocol.toon.external.ToonListRequest)request)).Build();
          case "SelectToon": return response.MergeFrom(implementation.SelectToon((global::bnet.protocol.toon.external.SelectToonRequest)request)).Build();
          case "CreateToon": return response.MergeFrom(implementation.CreateToon((global::bnet.protocol.toon.external.CreateToonRequest)request)).Build();
          case "DeleteToon": return response.MergeFrom(implementation.DeleteToon((global::bnet.protocol.toon.external.DeleteToonRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(IToonServiceExternal).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public ServerStub(IToonServiceExternal implementation) : this(implementation, true) {
      }
      public ServerStub(IToonServiceExternal implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "ToonList": return implementation.CallMethod(methodName, global::bnet.protocol.toon.external.ToonListRequest.ParseFrom(input, registry), global::bnet.protocol.toon.external.ToonListResponse.CreateBuilder());
          case "SelectToon": return implementation.CallMethod(methodName, global::bnet.protocol.toon.external.SelectToonRequest.ParseFrom(input, registry), global::bnet.protocol.toon.external.SelectToonResponse.CreateBuilder());
          case "CreateToon": return implementation.CallMethod(methodName, global::bnet.protocol.toon.external.CreateToonRequest.ParseFrom(input, registry), global::bnet.protocol.toon.external.CreateToonResponse.CreateBuilder());
          case "DeleteToon": return implementation.CallMethod(methodName, global::bnet.protocol.toon.external.DeleteToonRequest.ParseFrom(input, registry), global::bnet.protocol.toon.external.DeleteToonResponse.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(IToonServiceExternal).FullName, methodName);
        }
      }
    }
