...
namespace bnet.protocol.presence {
  ...
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial interface IPresenceService {
    global::bnet.protocol.NoData Subscribe(global::bnet.protocol.presence.SubscribeRequest subscribeRequest);
    global::bnet.protocol.NoData Unsubscribe(global::bnet.protocol.presence.UnsubscribeRequest unsubscribeRequest);
    global::bnet.protocol.NoData Update(global::bnet.protocol.presence.UpdateRequest updateRequest);
    global::bnet.protocol.presence.QueryResponse Query(global::bnet.protocol.presence.QueryRequest queryRequest);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class PresenceService : IPresenceService, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public PresenceService(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public PresenceService(pb::IRpcDispatch dispatch, bool dispose) {
    ...
    public global::bnet.protocol.NoData Subscribe(global::bnet.protocol.presence.SubscribeRequest subscribeRequest) {
       return dispatch.CallMethod("Subscribe", subscribeRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.NoData Unsubscribe(global::bnet.protocol.presence.UnsubscribeRequest unsubscribeRequest) {
       return dispatch.CallMethod("Unsubscribe", unsubscribeRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.NoData Update(global::bnet.protocol.presence.UpdateRequest updateRequest) {
       return dispatch.CallMethod("Update", updateRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.presence.QueryResponse Query(global::bnet.protocol.presence.QueryRequest queryRequest) {
       return dispatch.CallMethod("Query", queryRequest, global::bnet.protocol.presence.QueryResponse.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly IPresenceService implementation;
      public Dispatch(IPresenceService implementation) : this(implementation, true) {
      }
      public Dispatch(IPresenceService implementation, bool dispose) {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "Subscribe": return response.MergeFrom(implementation.Subscribe((global::bnet.protocol.presence.SubscribeRequest)request)).Build();
          case "Unsubscribe": return response.MergeFrom(implementation.Unsubscribe((global::bnet.protocol.presence.UnsubscribeRequest)request)).Build();
          case "Update": return response.MergeFrom(implementation.Update((global::bnet.protocol.presence.UpdateRequest)request)).Build();
          case "Query": return response.MergeFrom(implementation.Query((global::bnet.protocol.presence.QueryRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(IPresenceService).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public ServerStub(IPresenceService implementation) : this(implementation, true) {
      }
      public ServerStub(IPresenceService implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "Subscribe": return implementation.CallMethod(methodName, global::bnet.protocol.presence.SubscribeRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "Unsubscribe": return implementation.CallMethod(methodName, global::bnet.protocol.presence.UnsubscribeRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "Update": return implementation.CallMethod(methodName, global::bnet.protocol.presence.UpdateRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "Query": return implementation.CallMethod(methodName, global::bnet.protocol.presence.QueryRequest.ParseFrom(input, registry), global::bnet.protocol.presence.QueryResponse.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(IPresenceService).FullName, methodName);
        }
      }
    }
