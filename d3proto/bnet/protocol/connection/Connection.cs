...
namespace bnet.protocol.connection {
  ...
  public partial interface IConnectionService {
    global::bnet.protocol.connection.ConnectResponse Connect(global::bnet.protocol.connection.ConnectRequest connectRequest);
    global::bnet.protocol.connection.BindResponse Bind(global::bnet.protocol.connection.BindRequest bindRequest);
    global::bnet.protocol.connection.EchoResponse Echo(global::bnet.protocol.connection.EchoRequest echoRequest);
    global::bnet.protocol.NO_RESPONSE ForceDisconnect(global::bnet.protocol.connection.DisconnectNotification disconnectNotification);
    global::bnet.protocol.NO_RESPONSE Null(global::bnet.protocol.connection.NullRequest nullRequest);
    global::bnet.protocol.NoData Encrypt(global::bnet.protocol.connection.EncryptRequest encryptRequest);
    global::bnet.protocol.NO_RESPONSE RequestDisconnect(global::bnet.protocol.connection.DisconnectRequest disconnectRequest);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class ConnectionService : IConnectionService, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public ConnectionService(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public ConnectionService(pb::IRpcDispatch dispatch, bool dispose) {
    ...
    public global::bnet.protocol.connection.ConnectResponse Connect(global::bnet.protocol.connection.ConnectRequest connectRequest) {
       return dispatch.CallMethod("Connect", connectRequest, global::bnet.protocol.connection.ConnectResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.connection.BindResponse Bind(global::bnet.protocol.connection.BindRequest bindRequest) {
       return dispatch.CallMethod("Bind", bindRequest, global::bnet.protocol.connection.BindResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.connection.EchoResponse Echo(global::bnet.protocol.connection.EchoRequest echoRequest) {
       return dispatch.CallMethod("Echo", echoRequest, global::bnet.protocol.connection.EchoResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.NO_RESPONSE ForceDisconnect(global::bnet.protocol.connection.DisconnectNotification disconnectNotification) {
       return dispatch.CallMethod("ForceDisconnect", disconnectNotification, global::bnet.protocol.NO_RESPONSE.CreateBuilder());
    }
    
    public global::bnet.protocol.NO_RESPONSE Null(global::bnet.protocol.connection.NullRequest nullRequest) {
       return dispatch.CallMethod("Null", nullRequest, global::bnet.protocol.NO_RESPONSE.CreateBuilder());
    }
    
    public global::bnet.protocol.NoData Encrypt(global::bnet.protocol.connection.EncryptRequest encryptRequest) {
       return dispatch.CallMethod("Encrypt", encryptRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.NO_RESPONSE RequestDisconnect(global::bnet.protocol.connection.DisconnectRequest disconnectRequest) {
       return dispatch.CallMethod("RequestDisconnect", disconnectRequest, global::bnet.protocol.NO_RESPONSE.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly IConnectionService implementation;
      public Dispatch(IConnectionService implementation) : this(implementation, true) {
      }
      public Dispatch(IConnectionService implementation, bool dispose) {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "Connect": return response.MergeFrom(implementation.Connect((global::bnet.protocol.connection.ConnectRequest)request)).Build();
          case "Bind": return response.MergeFrom(implementation.Bind((global::bnet.protocol.connection.BindRequest)request)).Build();
          case "Echo": return response.MergeFrom(implementation.Echo((global::bnet.protocol.connection.EchoRequest)request)).Build();
          case "ForceDisconnect": return response.MergeFrom(implementation.ForceDisconnect((global::bnet.protocol.connection.DisconnectNotification)request)).Build();
          case "Null": return response.MergeFrom(implementation.Null((global::bnet.protocol.connection.NullRequest)request)).Build();
          case "Encrypt": return response.MergeFrom(implementation.Encrypt((global::bnet.protocol.connection.EncryptRequest)request)).Build();
          case "RequestDisconnect": return response.MergeFrom(implementation.RequestDisconnect((global::bnet.protocol.connection.DisconnectRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(IConnectionService).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public ServerStub(IConnectionService implementation) : this(implementation, true) {
      }
      public ServerStub(IConnectionService implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "Connect": return implementation.CallMethod(methodName, global::bnet.protocol.connection.ConnectRequest.ParseFrom(input, registry), global::bnet.protocol.connection.ConnectResponse.CreateBuilder());
          case "Bind": return implementation.CallMethod(methodName, global::bnet.protocol.connection.BindRequest.ParseFrom(input, registry), global::bnet.protocol.connection.BindResponse.CreateBuilder());
          case "Echo": return implementation.CallMethod(methodName, global::bnet.protocol.connection.EchoRequest.ParseFrom(input, registry), global::bnet.protocol.connection.EchoResponse.CreateBuilder());
          case "ForceDisconnect": return implementation.CallMethod(methodName, global::bnet.protocol.connection.DisconnectNotification.ParseFrom(input, registry), global::bnet.protocol.NO_RESPONSE.CreateBuilder());
          case "Null": return implementation.CallMethod(methodName, global::bnet.protocol.connection.NullRequest.ParseFrom(input, registry), global::bnet.protocol.NO_RESPONSE.CreateBuilder());
          case "Encrypt": return implementation.CallMethod(methodName, global::bnet.protocol.connection.EncryptRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "RequestDisconnect": return implementation.CallMethod(methodName, global::bnet.protocol.connection.DisconnectRequest.ParseFrom(input, registry), global::bnet.protocol.NO_RESPONSE.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(IConnectionService).FullName, methodName);
        }
      }
    }
