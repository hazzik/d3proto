...
namespace bnet.protocol.search {
  ...
  public partial interface ISearchService {
    global::bnet.protocol.search.FindMatchesResponse FindMatches(global::bnet.protocol.search.FindMatchesRequest findMatchesRequest);
    global::bnet.protocol.NO_RESPONSE SetObject(global::bnet.protocol.search.SetObjectRequest setObjectRequest);
    global::bnet.protocol.NO_RESPONSE RemoveObjects(global::bnet.protocol.search.RemoveObjectsRequest removeObjectsRequest);
  }
  ...
  public partial class SearchService : ISearchService, pb::IRpcDispatch, global::System.IDisposable {
    ...
    public global::bnet.protocol.search.FindMatchesResponse FindMatches(global::bnet.protocol.search.FindMatchesRequest findMatchesRequest) {
       return dispatch.CallMethod("FindMatches", findMatchesRequest, global::bnet.protocol.search.FindMatchesResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.NO_RESPONSE SetObject(global::bnet.protocol.search.SetObjectRequest setObjectRequest) {
       return dispatch.CallMethod("SetObject", setObjectRequest, global::bnet.protocol.NO_RESPONSE.CreateBuilder());
    }
    
    public global::bnet.protocol.NO_RESPONSE RemoveObjects(global::bnet.protocol.search.RemoveObjectsRequest removeObjectsRequest) {
       return dispatch.CallMethod("RemoveObjects", removeObjectsRequest, global::bnet.protocol.NO_RESPONSE.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "FindMatches": return response.MergeFrom(implementation.FindMatches((global::bnet.protocol.search.FindMatchesRequest)request)).Build();
          case "SetObject": return response.MergeFrom(implementation.SetObject((global::bnet.protocol.search.SetObjectRequest)request)).Build();
          case "RemoveObjects": return response.MergeFrom(implementation.RemoveObjects((global::bnet.protocol.search.RemoveObjectsRequest)request)).Build();
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "FindMatches": return implementation.CallMethod(methodName, global::bnet.protocol.search.FindMatchesRequest.ParseFrom(input, registry), global::bnet.protocol.search.FindMatchesResponse.CreateBuilder());
          case "SetObject": return implementation.CallMethod(methodName, global::bnet.protocol.search.SetObjectRequest.ParseFrom(input, registry), global::bnet.protocol.NO_RESPONSE.CreateBuilder());
          case "RemoveObjects": return implementation.CallMethod(methodName, global::bnet.protocol.search.RemoveObjectsRequest.ParseFrom(input, registry), global::bnet.protocol.NO_RESPONSE.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(ISearchService).FullName, methodName);
        }
      }
    }
