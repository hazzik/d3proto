...
namespace bnet.protocol.notification {
  ...
  public partial interface INotificationService {
    global::bnet.protocol.NoData SendNotification(global::bnet.protocol.notification.Notification notification);
    global::bnet.protocol.NoData RegisterClient(global::bnet.protocol.notification.RegisterClientRequest registerClientRequest);
    global::bnet.protocol.NoData UnregisterClient(global::bnet.protocol.notification.UnregisterClientRequest unregisterClientRequest);
    global::bnet.protocol.notification.FindClientResponse FindClient(global::bnet.protocol.notification.FindClientRequest findClientRequest);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class NotificationService : INotificationService, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public NotificationService(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public NotificationService(pb::IRpcDispatch dispatch, bool dispose) {
    ...
    public global::bnet.protocol.NoData SendNotification(global::bnet.protocol.notification.Notification notification) {
       return dispatch.CallMethod("SendNotification", notification, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.NoData RegisterClient(global::bnet.protocol.notification.RegisterClientRequest registerClientRequest) {
       return dispatch.CallMethod("RegisterClient", registerClientRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.NoData UnregisterClient(global::bnet.protocol.notification.UnregisterClientRequest unregisterClientRequest) {
       return dispatch.CallMethod("UnregisterClient", unregisterClientRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    
    public global::bnet.protocol.notification.FindClientResponse FindClient(global::bnet.protocol.notification.FindClientRequest findClientRequest) {
       return dispatch.CallMethod("FindClient", findClientRequest, global::bnet.protocol.notification.FindClientResponse.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly INotificationService implementation;
      public Dispatch(INotificationService implementation) : this(implementation, true) {
      }
      public Dispatch(INotificationService implementation, bool dispose) {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "SendNotification": return response.MergeFrom(implementation.SendNotification((global::bnet.protocol.notification.Notification)request)).Build();
          case "RegisterClient": return response.MergeFrom(implementation.RegisterClient((global::bnet.protocol.notification.RegisterClientRequest)request)).Build();
          case "UnregisterClient": return response.MergeFrom(implementation.UnregisterClient((global::bnet.protocol.notification.UnregisterClientRequest)request)).Build();
          case "FindClient": return response.MergeFrom(implementation.FindClient((global::bnet.protocol.notification.FindClientRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(INotificationService).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public ServerStub(INotificationService implementation) : this(implementation, true) {
      }
      public ServerStub(INotificationService implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "SendNotification": return implementation.CallMethod(methodName, global::bnet.protocol.notification.Notification.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "RegisterClient": return implementation.CallMethod(methodName, global::bnet.protocol.notification.RegisterClientRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "UnregisterClient": return implementation.CallMethod(methodName, global::bnet.protocol.notification.UnregisterClientRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          case "FindClient": return implementation.CallMethod(methodName, global::bnet.protocol.notification.FindClientRequest.ParseFrom(input, registry), global::bnet.protocol.notification.FindClientResponse.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(INotificationService).FullName, methodName);
        }
      }
    }
  ...
  public partial interface INotificationListener {
    global::bnet.protocol.NO_RESPONSE OnNotificationReceived(global::bnet.protocol.notification.Notification notification);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class NotificationListener : INotificationListener, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public NotificationListener(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public NotificationListener(pb::IRpcDispatch dispatch, bool dispose) {
      if (null == (this.dispatch = dispatch)) throw new global::System.ArgumentNullException();
      this.dispose = dispose && dispatch is global::System.IDisposable;
    }
    ...
    public global::bnet.protocol.NO_RESPONSE OnNotificationReceived(global::bnet.protocol.notification.Notification notification) {
       return dispatch.CallMethod("OnNotificationReceived", notification, global::bnet.protocol.NO_RESPONSE.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly INotificationListener implementation;
      public Dispatch(INotificationListener implementation) : this(implementation, true) {
      }
      public Dispatch(INotificationListener implementation, bool dispose) {
        if (null == (this.implementation = implementation)) throw new global::System.ArgumentNullException();
        this.dispose = dispose && implementation is global::System.IDisposable;
      }
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        where TBuilder : pb::IBuilderLite<TMessage, TBuilder> {
        switch(methodName) {
          case "OnNotificationReceived": return response.MergeFrom(implementation.OnNotificationReceived((global::bnet.protocol.notification.Notification)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(INotificationListener).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      private readonly bool dispose;
      private readonly pb::IRpcDispatch implementation;
      public ServerStub(INotificationListener implementation) : this(implementation, true) {
      }
      public ServerStub(INotificationListener implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      public ServerStub(pb::IRpcDispatch implementation) : this(implementation, true) {
      }
      public ServerStub(pb::IRpcDispatch implementation, bool dispose) {
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "OnNotificationReceived": return implementation.CallMethod(methodName, global::bnet.protocol.notification.Notification.ParseFrom(input, registry), global::bnet.protocol.NO_RESPONSE.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(INotificationListener).FullName, methodName);
        }
      }
    }
