...
namespace bnet.protocol.authentication {
  ...
  public partial interface IAuthenticationClient {
    global::bnet.protocol.authentication.ModuleLoadResponse ModuleLoad(global::bnet.protocol.authentication.ModuleLoadRequest moduleLoadRequest);
    global::bnet.protocol.NoData ModuleMessage(global::bnet.protocol.authentication.ModuleMessageRequest moduleMessageRequest);
  }
  
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class AuthenticationClient : IAuthenticationClient, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public AuthenticationClient(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public AuthenticationClient(pb::IRpcDispatch dispatch, bool dispose) {
    ...
    public global::bnet.protocol.authentication.ModuleLoadResponse ModuleLoad(global::bnet.protocol.authentication.ModuleLoadRequest moduleLoadRequest) {
       return dispatch.CallMethod("ModuleLoad", moduleLoadRequest, global::bnet.protocol.authentication.ModuleLoadResponse.CreateBuilder());
    }
    
    public global::bnet.protocol.NoData ModuleMessage(global::bnet.protocol.authentication.ModuleMessageRequest moduleMessageRequest) {
       return dispatch.CallMethod("ModuleMessage", moduleMessageRequest, global::bnet.protocol.NoData.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly IAuthenticationClient implementation;
      public Dispatch(IAuthenticationClient implementation) : this(implementation, true) {
      }
      public Dispatch(IAuthenticationClient implementation, bool dispose) {
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        switch(methodName) {
          case "ModuleLoad": return response.MergeFrom(implementation.ModuleLoad((global::bnet.protocol.authentication.ModuleLoadRequest)request)).Build();
          case "ModuleMessage": return response.MergeFrom(implementation.ModuleMessage((global::bnet.protocol.authentication.ModuleMessageRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(IAuthenticationClient).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      ...
      public ServerStub(IAuthenticationClient implementation) : this(implementation, true) {
      }
      public ServerStub(IAuthenticationClient implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "ModuleLoad": return implementation.CallMethod(methodName, global::bnet.protocol.authentication.ModuleLoadRequest.ParseFrom(input, registry), global::bnet.protocol.authentication.ModuleLoadResponse.CreateBuilder());
          case "ModuleMessage": return implementation.CallMethod(methodName, global::bnet.protocol.authentication.ModuleMessageRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(IAuthenticationClient).FullName, methodName);
        }
      }
    }
  ...
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial interface IAuthenticationServer {
    global::bnet.protocol.authentication.LogonResponse Logon(global::bnet.protocol.authentication.LogonRequest logonRequest);
    global::bnet.protocol.NoData ModuleMessage(global::bnet.protocol.authentication.ModuleMessageRequest moduleMessageRequest);
  }
  ...
  [global::System.Runtime.CompilerServices.CompilerGeneratedAttribute()]
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ProtoGen", "2.3.0.277")]
  public partial class AuthenticationServer : IAuthenticationServer, pb::IRpcDispatch, global::System.IDisposable {
    private readonly bool dispose;
    private readonly pb::IRpcDispatch dispatch;
    public AuthenticationServer(pb::IRpcDispatch dispatch) : this(dispatch, true) {
    }
    public AuthenticationServer(pb::IRpcDispatch dispatch, bool dispose) {
      if (null == (this.dispatch = dispatch)) throw new global::System.ArgumentNullException();
      this.dispose = dispose && dispatch is global::System.IDisposable;
    }
    ...
    public global::bnet.protocol.authentication.LogonResponse Logon(global::bnet.protocol.authentication.LogonRequest logonRequest) {
       return dispatch.CallMethod("Logon", logonRequest, global::bnet.protocol.authentication.LogonResponse.CreateBuilder());
    }
    ...
    public partial class Dispatch : pb::IRpcDispatch, global::System.IDisposable {
      private readonly bool dispose;
      private readonly IAuthenticationServer implementation;
      public Dispatch(IAuthenticationServer implementation) : this(implementation, true) {
      }
      public Dispatch(IAuthenticationServer implementation, bool dispose) {
        if (null == (this.implementation = implementation)) throw new global::System.ArgumentNullException();
        this.dispose = dispose && implementation is global::System.IDisposable;
      }
      ...
      public TMessage CallMethod<TMessage, TBuilder>(string methodName, pb::IMessageLite request, pb::IBuilderLite<TMessage, TBuilder> response)
        ...
        where TBuilder : pb::IBuilderLite<TMessage, TBuilder> {
        switch(methodName) {
          case "Logon": return response.MergeFrom(implementation.Logon((global::bnet.protocol.authentication.LogonRequest)request)).Build();
          case "ModuleMessage": return response.MergeFrom(implementation.ModuleMessage((global::bnet.protocol.authentication.ModuleMessageRequest)request)).Build();
          default: throw new global::System.MissingMethodException(typeof(IAuthenticationServer).FullName, methodName);
        }
      }
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    ...
    public partial class ServerStub : pb::IRpcServerStub, global::System.IDisposable {
      private readonly bool dispose;
      private readonly pb::IRpcDispatch implementation;
      public ServerStub(IAuthenticationServer implementation) : this(implementation, true) {
      }
      public ServerStub(IAuthenticationServer implementation, bool dispose) : this(new Dispatch(implementation, dispose), dispose) {
      }
      public ServerStub(pb::IRpcDispatch implementation) : this(implementation, true) {
      }
      public ServerStub(pb::IRpcDispatch implementation, bool dispose) {
      ...
      public pb::IMessageLite CallMethod(string methodName, pb::ICodedInputStream input, pb::ExtensionRegistry registry) {
        switch(methodName) {
          case "Logon": return implementation.CallMethod(methodName, global::bnet.protocol.authentication.LogonRequest.ParseFrom(input, registry), global::bnet.protocol.authentication.LogonResponse.CreateBuilder());
          case "ModuleMessage": return implementation.CallMethod(methodName, global::bnet.protocol.authentication.ModuleMessageRequest.ParseFrom(input, registry), global::bnet.protocol.NoData.CreateBuilder());
          default: throw new global::System.MissingMethodException(typeof(IAuthenticationServer).FullName, methodName);
        }
      }
